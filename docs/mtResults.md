This page presents results of the MT system. 
The test sets used in this section provide both manual transcripts and the output of an ASR system. 
We report results for both cases.
