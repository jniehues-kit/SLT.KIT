...
cat /tmp/eval/$set.hyp | sed -e "s/&/&amp;/g" | perl /opt/SLT.KIT/scripts/evaluate/wrap-xml.perl $tl /data/orig/eval/$set/IWSLT.$set/IWSLT.TED.$set.$sl-$tl.$sl.xml $systemName > /tmp/eval/$set.xml
cat /tmp/eval/$set.no-case.hyp | sed -e "s/&/&amp;/g" | perl /opt/SLT.KIT/scripts/evaluate/wrap-xml.perl $tl /data/orig/eval/$set/IWSLT.$set/IWSLT.TED.$set.$sl-$tl.$sl.xml $systemName > /tmp/eval/$set.no-case.xml
